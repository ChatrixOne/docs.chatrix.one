...
[^1]: За криптиране от край до край е необходимо да активирате [OMEMO](/faq#omemo) или [OpenPGP](https://bg.wikipedia.org/wiki/Достатъчно_добра_поверителност) във вашия XMPP клиент.
...
-   :material-account:{ .lg .middle } __Профил__
    ...
    [:octicons-arrow-right-24: Настройка на профил](/account/registration)
...
-   :material-apps:{ .lg .middle } __Софтуер__
    ...
    [:octicons-arrow-right-24: Инсталиране](/clients)
...
-   :material-exclamation-thick:{ .lg .middle } __Условия__
    ...
    [:octicons-arrow-right-24: Правила](/terms)
...
-   :material-shield-account:{ .lg .middle } __Поверителност__
    ...
    [:octicons-arrow-right-24: Поверителност](/privacy)
...
-   :material-head-question:{ .lg .middle } __Често задавани въпроси__
    ...
    [:octicons-arrow-right-24: ЧЗВ](/faq)

-   :material-contacts:{ .lg .middle } __Контакти__

    ---

    За въпроси, на които не е отговорено в [ЧЗВ](/faq) и проблеми свързани с използване на XMPP услугата предлагана от **Chatrix.One**.

    [:octicons-arrow-right-24: Контакти](/about#контакти)

</div>

Сървърът притежава оценка **A+** в [Crypt-check](https://crypt.fyi), **A** в [XMPP Compliance Checker](https://compliance.conversations.im/) и е **100% XMPP съвместим**. DNSSEC е активиран.
