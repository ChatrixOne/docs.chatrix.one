...
## Къде мога да намеря публични стаи, към които да се присъединя?

Списък с публични стаи, със свободен достъп, можете да откриете на страницата на [Search Jabber Network](https://search.jabber.network).
...
## Как изглежда XMPP мрежата?

Примерна визуализация на XMPP мрежата, е достъпна на страницата на [XMPP Network Graph](https://xmppnetwork.goodbytes.im/).
...
Пълна информация относно регистрирането на профил в **Chatrix.One** е налична в раздела [Регистрация](/account/registration).


## Има ли публикуван шаблон на имейл за регистрация?

Шаблон на примерен имейл за регистрация е наличен в раздела [Регистрация](/account/registration#__tabbed_1_1).


## Има ли публикуван шаблон на XMPP съобщение за регистрация?

Шаблон на примерно XMPP съобщение за регистрация е налично в раздела [Регистрация](/account/registration#__tabbed_1_2).


## Защо не получавам писмо с линк за регистрация?

Проверете папка спам във вашата поща.
...
Подробна информация относно наличните клиенти за работа с **Chatrix.One**, в зависимост от операционната система която използвате, можете да намерите в раздел [Клиенти](/clients). За Ваше удобство връзките за сваляне са публикувани и в редовете по-долу.
...
Можете да смените паролата и чрез онлайн формата за смяна на парола [тук](/account/change-password).
...
Можете да изтриете Вашия профил и чрез онлайн формата [тук](/account/delete-account).
...
Разбира се. Такива има има и те са задължителни за всички. Моля, да се запознаете с тях в раздела [Условия](/terms).


## Длъжен ли съм да пиша само на кирилица?

Можете да пишете на какъвто език пожелаете, стига да спазвате [правилата](/terms) за ползване на услугата.
...
- :material-check-all:{ .green} - Съобщението е получено успешно от получателя и е прочетено.
...
- Сървърът не работи.
    ...
    !!! success "Решение"
        ...
        Изчакайте проблемът да бъде отстранен. За работоспособността на услугата, можете да следите в раздел [Статус](/status) и по-точно частта [Достъпност - XMPP](/status#достъпност---xmpp).
...
- Възможно е към момента регистрацията да е временно забранена. Моля, проверете в раздел [Статус](/status) и по-точно частта [Регистрация на профил](/status#%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8F-%D0%BD%D0%B0-%D0%BF%D1%80%D0%BE%D1%84%D0%B8%D0%BB). Трябва да е обозначена като ++"ОТВОРЕНА"++;
...
Ако статусът на регистрациите е обозначен като ++"ЗАТВОРЕНА"++, ще се наложи да използвате някой от другите възможни методи за регистриране на профил, описани в раздел [Регистрация](/account/registration) и по точно частта [Начини за регистриране на профил](/account/registration#%D0%BD%D0%B0%D1%87%D0%B8%D0%BD%D0%B8-%D0%B7%D0%B0-%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B8%D1%80%D0%B0%D0%BD%D0%B5-%D0%BD%D0%B0-%D0%BF%D1%80%D0%BE%D1%84%D0%B8%D0%BB). За всички останали случаи, решението е да опитате отново по-късно.
...
## Защо CAPTCHA се визуализира едва забележимо?

Колкото повече акаунти се регистрират за 24 часа, токлкова по-блед става кодът. Това е направено с цел да се ограничи броят на **SPAM** регистрациите. Опитайте по-късно или се свържете с администратор за съдействие.
...
Подробна информация ще намерите в раздел [Поверителност](/privacy#%D0%BF%D1%80%D0%B5%D0%B3%D0%BB%D0%B5%D0%B4-%D0%BD%D0%B0-%D1%81%D1%8A%D1%85%D1%80%D0%B0%D0%BD%D1%8F%D0%B2%D0%B0%D0%BD%D0%B8%D1%82%D0%B5-%D0%B4%D0%B0%D0%BD%D0%BD%D0%B8).
...
!!! info "Информация"
    ...
    Едно от нещата към които се отнасям изключително отговорно, е личната комуникация да остане наистина лична. За повече информация вижте раздела [Поверителност](/privacy).
...
Достатъчно е, да помогнете със заплащането на месечна сметка, за някой от разходите посочени в [Какви разходи поражда такъв вид услуга?](#какви-разходи-поражда-такъв-вид-услуга).
...
!!! info "Информация"
    ...
    Само XMPP, NTP и уебсайтовете са публично достъпни услуги. Останалите са в експериментална фаза. Ако все пак, някоя от тях получи публичен достъп, това ще бъде анонсирано на уеб страницата. Също така, ще забележете промяната в цвета на символа *кръгче с отметка*, пред съответната услуга, от сив :material-checkbox-marked-circle:{ .gray } в зелен цвят :material-checkbox-marked-circle:{ .green }. Адресът за достъп, ще бъде изписан срещу съответната услуга.
...
Да, има. Моля, да се запознаете с тях в раздел [Условия](/terms).


## Мога ли да подам сигнал за нарушение на правилата за ползване на услугата?

Вижте раздел [Условия](/terms) и по-точно частта [Подаване на сигнал за нарушение](/terms#%D0%BF%D0%BE%D0%B4%D0%B0%D0%B2%D0%B0%D0%BD%D0%B5-%D0%BD%D0%B0-%D1%81%D0%B8%D0%B3%D0%BD%D0%B0%D0%BB-%D0%B7%D0%B0-%D0%BD%D0%B0%D1%80%D1%83%D1%88%D0%B5%D0%BD%D0%B8%D0%B5).


## Защо е изтрит профилът ми?

Прочетете раздел [Условия](/terms) и по точно частта [Допълнителни](/terms#%D0%B4%D0%BE%D0%BF%D1%8A%D0%BB%D0%BD%D0%B8%D1%82%D0%B5%D0%BB%D0%BD%D0%B8).


## Как да възстановя изтрит профил?

Не съществува такава опция. Веднъж изтрит, профилът не може да бъде възстановен. Прочетете раздел [Условия](/terms) и по точно частта [Допълнителни](/terms#%D0%B4%D0%BE%D0%BF%D1%8A%D0%BB%D0%BD%D0%B8%D1%82%D0%B5%D0%BB%D0%BD%D0%B8).
...
Информация за настъпили инциденти, прекъсвания в услугата и предстоящи профилактики ще бъдат публикувани в раздел [Статус](/status) и по-точно в частта [Информация за настъпили инциденти](/status#информация-за-настъпили-инциденти).

## Каква технологична база използва Chatrix.One?

Chatrix.One е изграден изцяло на базата на софтуер с отворен код.

| Технология | Роля |
|:-----------|:-----|
| [XMPP](https://xmpp.org/) | Отворен протокол за съобщения — основата на услугата |
| [Ejabberd](https://github.com/processone/ejabberd) | XMPP сървърна платформа |
| [Ubuntu](https://ubuntu.com/) / [Debian](https://www.debian.org/) | Сървърни операционни системи |
| [NGINX](https://nginx.org/) | Уеб сървър и reverse proxy |
| [OpenSSL](https://www.openssl.org/) | Библиотека за TLS криптиране |
| [Ansible](https://www.ansible.com/) | Автоматизация на инфраструктурата |
| [Docker](https://www.docker.com/) | Контейнерна среда за изпълнение |
| [Git](https://git-scm.com/) | Управление на версиите |


## Налична ли е техническа информация за услугата?

Проверете в раздел [Статус](/status) и по-точно частта [Технически данни](/status#технически-данни).


## Защо в **XMPP Providers** категорията е **B**, а не както преди **A**?

Защото регистрацията през инсталирано приложение вече е забранена. Направено е с цел предпазване на услугата от бот регистрации. Всички останали функционалности остават непроменени.


## Как мога да се свържа с вас?

Контактите са достъпни в долната част на страницата, както и в раздела [За нас](/about#контакти). Ако използвате мобилно устройство моля, проверете в менюто :material-menu:.
