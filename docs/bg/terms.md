...
Моля, запознайте се с правилата, които **всеки** потребител, модератор или администратор е длъжен да спазва.
...
- Използване на услугата за автоматизирана комуникация с крайни потребители, включително, но не само, като част от чат-ботове, виртуални асистенти, **live chat** системи, **helpdesk** платформи или функционалности от типа „Свържи се с нас“;
...
- Регистриране на профил, чието име наподобява **администраторски** или **модераторски** профил;
- Регистриране на профил, чието име съдържа или наподобява думата **chatrix**;
...
- Разпространение на пропаганда, насочена към подбуждане на насилие, омраза или дискриминация;
- Разпространение на дезинформация;
- Използване на услугата за координация на насилие, включително призиви за насилие, заплахи или организиране на вредни действия насочени срещу хора, животни или гупи от хора и/или животни;
...
- Използван е за последно преди повече от 90 дни;
- Получено е предупреждение за нарушение.

!!! info "Информация"

    В случай, че профилът Ви бъде маркиран за изтриване, Вие ще получите системно съобщение, с което да бъдете предупредени за предстоящото събитие. Ще Ви бъде предоставена възможност да предприемете действие в рамките на 24 часа, ако желаете изтриването да бъде отменено.
...
## Автоматично изтриване на профил

Профили регистрирани от IP адреси, които според [**Scamalytics**](https://scamalytics.com/) са с висок риск от измама (**Fraud Risk**) или се свързват с дейността на центрове за данни, ще бъдат автоматично изтривани **без** предупреждение.
...
!!! info "Информация"
    ...
    Изтриването на профил, може да стане през инсталиран от Вас клиент, както и онлайн в раздел [Профил](/account/registration) и по-точно частта [Дерегистрация](/account/delete-account).
...
Препоръчвам Ви, да се запознаете с [политиката за поверителност](/privacy) на **Chatrix.One**.
