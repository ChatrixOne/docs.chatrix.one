...
???- bug "Планирани профилактики"
    ...
    |:------------|:----------------:|:------------------------------------------------------:|
    | 29.08.2026  |05:30 - 6:30 EET  | Възможни са временни прекъсвания на XMPP услугата  |
...
| Тест          | Резултат  |
|:--------------|:---------:|
| DNSSEC и DANE | <a href='https://www.huque.com/bin/danecheck?domain=chatrix.one&port=5223&starttls=None&namecheck=on'><img src='https://img.shields.io/badge/DNSSEC%2BDANE_Check-A-00c896?logo=data:image/svg%2bxml;base64,'></a> |
| CryptCheck | <a href='https://cryptcheck.fr/xmpp/chatrix.one'><img src='https://img.shields.io/badge/CryptCheck-A%2B-00c896?logo=data:image/svg%2bxml;base64,'></a> |
...
| Параметър            | Стойност                       |
|:---------------------|:------------------------------:|
| Процесор             | ARM Ampere<sup>&reg;</sup>Altra<sup>&trade;</sup> |
| Оперативна памет     | 8GB                             |
| Дисково пространство | 64GB (Криптирано)               |
| Файлова система      | ext4                            |
| Операционна система  | Ubuntu 22.04 (Jammy Jellyfish)  |
| Ejabberd версия  | 26.04                               |
| Архивиране           | Ежедневно                       |
| Локация              | Швейцария                       |
...
| Операционна система  | Debian 13 (Trixie)             |
| Локация              | България                       |
...
#### Обновяване на Ejabberd до версия [26.07](https://github.com/processone/ejabberd/releases/tag/26.07)

- Основно корекции на сигурността и надеждността, насочени към множество уязвимости при удостоверяване, OAuth, PubSub, WebAdmin, качване на файлове и уеб модули;
- По-добро управление на покани чрез нови потребителски и администраторски интерфейси;
- Поддръжка на ConverseJS 14.
 
### 25.07.2026

#### Даунгрейд на сървъра

Поради драстичното увеличение на разходите за хостинг (благодарение на AI рампокалипсиса), наличната RAM памет е намалена от 12GB на 8GB.

### 14.05.2026

#### Цялостен редизайн на страницата с документация

Темата е напълно обновена, с цел визуално съответствие с обновения основен уебсайт [Chatrix.One](https://chatrix.one).
...
#### Обновяване на Ejabberd до версия [26.04](https://github.com/processone/ejabberd/releases/tag/26.04)

- Подобрения в сигурността - Ограничава максималната памет, използвана от **XML parser** за обработка на **XMPP payloads**, с цел предотвратяване на потенциална атака от типа **DoS**.

### 05.04.2026

#### Обновяване на Ejabberd до версия [26.03](https://github.com/processone/ejabberd/releases/tag/26.03)

- Поправка на **MySQL** удостоверяването при TLS връзки, които изискваха смяна на плъгина за оторизация;
- Подобрено управление на флага в **scram** '**wanted to use channel-bindings but was not offered one**';
- Добавена възможност стойностите в `mod_options` да зависят от други опции;
- Премахване на грешката при класифициране на самостоятелни чат състояния (**chat states**);
- Поправка на някои предупреждаващи съобщения при компилиране с **Erlang/OTP** 29;
- Документирано е задаването на празни списъци в `ejabberdctl` и **WebAdmin**;
- Добавена поддръжка на хедърите **Etag** и **If-Modified-Since** за файлове, обслужвани от `ejabberd_http` и `mod_http_upload`;
- Игнориране на интервалите в края на хедъра за хост в `ejabberd_http`;
- Добавена възможност за маркиране, че колона може да бъде **null** в `e_sql_schema`;
- Добавени тестове за **SASL2**;
- Подобрена надеждност при почистването на таблици по време на тестове;

### 11.02.2026

#### Обновяване на Ejabberd до версия [26.02](https://github.com/processone/ejabberd/releases/tag/26.02)

- Коригиран проблем с добавянето на данни за `hats` в присъствия, изпратени от групови чатове;
- Премахнат модул `mod_muc_occupantid` и интегриране директно в `mod_muc`;
- Коригиран проблем с нулирането на стойностите на `occupantid` след рестартиране на **EJabberd**;
- Подобрена обработка на медиирани покани за групов чат в `mod_block_stranger`;
- Правилно инсталиране на шаблоните от `mod_invites` по време на извикването на `make install`;
- Подобрения в грешките на `mod_invites`;
- Подобрения в достъпността на `mod_invites`;
- Подобрена обработката на заявки с невалидни URL, обработени от `ejabberd_http`;
- Подобрена обработката на невалидни отговори на `disco` заявки в `mod_pubsub_serverinfo`;
- Коригирано конвертиране на MUC конфигурации на стаи от **EJabberd**, по-стари от версия 21.12;
- Корекция на автоматичното влизане в **WebAdmin** портала.

### 23.01.2026

#### Обновяване на Ejabberd до версия [26.01](https://github.com/processone/ejabberd/releases/tag/26.01)

- **Database Serialization** - позволява лесна миграция на базата данни;
- **Roster Invites and Invite-based Account Registration** - покана за регистриране на профил, чрез генериран линк.
...
#### Обновяване на Ejabberd до версия [25.10](https://github.com/processone/ejabberd/releases/tag/25.10)

- Добавени са още **Ad-Hoc** команди от **XEP-0133**;
- Подобрена поддръжка за **XEP-0317 Hats**.
...
#### Обновяване на Ejabberd до версия [25.04](https://github.com/processone/ejabberd/releases/tag/25.04)

- Важна корекция на сигурността и няколко корекции на грешки;
- Корекция в обработката на множество occupant-id;
- Нова API команда.
...
- Възможност за изпълнение на API команди през XMPP клиент.
...
![Chatrix.One Logo](../assets/logo-bird-white.png#only-dark){ width="200" }
![Chatrix.One Logo](../assets/logo-bird-blue.png#only-light){ width="200" }
