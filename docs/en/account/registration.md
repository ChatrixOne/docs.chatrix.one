...
!!! info "Information"
     ...
     In case the username you have chosen is taken, you will receive additional emails to notify you about the situation.

After a successful initial login to the system, I recommend that you change the automatically generated password to one of your choice. Please be wise in your choice. Passwords like `123abc`, `1234567890`, `P@ssword123` and similar are cracked in **seconds** and are a sure way to become a victim of hackers and lose your account.
...
If you already have an account, the next step is to install the [required software (client)](/en/clients) for communication.