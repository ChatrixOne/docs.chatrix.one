...
Detailed information about the clients available for working with **Chatrix.One** depending on the operating system you use, can be found in the section [Clients](/en/clients). For your convenience, the download links are also posted in the lines below.
...
You can also delete your account using the online form [here](/en/account/delete-account).
...
- It is possible that the registration is temporarily prohibited at the moment. Please check the [Status](/en/status) section and specifically the [Account Registration](/en/status#account-registrations). It must be marked as ++"OPEN"++;
...
Information about incidents, service interruptions and upcoming maintenance will be published in the [Status](/en/status) page and more specifically in the [Information about occurred incidents](/en/status#information-about-occurred-incidents) section.

## What technology stack powers Chatrix.One?

Chatrix.One is built entirely on open source software.

| Technology | Role |
|:-----------|:-----|
| [XMPP](https://xmpp.org/) | Open messaging protocol — the foundation of the service |
| [Ejabberd](https://github.com/processone/ejabberd) | XMPP server platform |
| [Ubuntu](https://ubuntu.com/) / [Debian](https://www.debian.org/) | Server operating systems |
| [NGINX](https://nginx.org/) | Web server and reverse proxy |
| [OpenSSL](https://www.openssl.org/) | TLS encryption library |
