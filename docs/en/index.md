...
[^1]: For end-to-end encryption, you need to enable [OMEMO](/en/faq#what-is-omemo) or [OpenPGP](https://en.wikipedia.org/wiki/Pretty_Good_Privacy) in your **XMPP** client.
...
-   :material-account:{ .lg .middle } __Account__
    ...
    [:octicons-arrow-right-24: Profile setup](/en/account/registration)
...
-   :material-apps:{ .lg .middle } __Software__
    ...
    [:octicons-arrow-right-24: Install](/en/clients)
...
-   :material-exclamation-thick:{ .lg .middle } __Rules__
    ...
    [:octicons-arrow-right-24: Terms](/en/terms)
...
-   :material-head-question:{ .lg .middle } __Frequently Asked Questions__
    ...
    [:octicons-arrow-right-24: FAQ](/en/faq)

-   :material-contacts:{ .lg .middle } __Contacts__

    ---

    For questions, not answered in the [FAQ](/en/faq) and problems related to the **XMPP** service offered by **Chatrix.One**.

    [:octicons-arrow-right-24: Contacts](/en/about#contacts)

</div>

The server holds an **A+** rating on [Crypt-check](https://crypt.fyi), an **A** on [XMPP Compliance Checker](https://compliance.conversations.im/), and is **100% XMPP compliant**. DNSSEC is enabled.
