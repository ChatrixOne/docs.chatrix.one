...
!!! info "Information"
     ...
     Deleting an account can be done through a client installed by you, as well as online in the [Account](/en/account/registration) section and more specifically the part [Unregister Account](/en/account/delete-account).
...
I recommend that you familiarize yourself with the [Privacy policy](/en/privacy) of **Chatrix.One**.
