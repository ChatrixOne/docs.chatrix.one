...
За мен *Линукск системната администрация* е хоби! През годините **XMPP** услугата, предлагана безплатно от **Chatrix.One**, многократно е мигрирала през различен софтуер и хардуер. Стремежът винаги е бил минимална консумация на електроенергия и максимална стабилност на комуникацията.
...
След прехода, от **ARM** към **x86** архитектура през 2018г., **Chatrix.One** става публично достъпен. Благодарение на проекта **Conversations** и появявата на **OMEMO**, като метод за криптиране, **XMPP** търпи множество подобрения.
