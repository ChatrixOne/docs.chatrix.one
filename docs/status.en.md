...
???- bug "Scheduled maintenance"
     ...
     |:------------|:----------------:|:-------------------------------------------:|
     | 28.06.2025  |05:30 - 6:30 EET  | **XMPP** service interruptions are possible |
...
| **XMPP Network Graph** | [View in real time](https://xmppnetwork.goodbytes.im/?focus=chatrix.one)|
