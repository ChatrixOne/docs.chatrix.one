...
!!! warning  "Важно"
    ...
    От 01.02.2026г., основният начин за регистриране на профил в **Chatrix.One**, е с помощта на покана. Вариантите са два. Под формата на линк за **URL** адрес или чрез сканиране на **QR** код.
...
Регистрацията чрез покана е предпочитаният начин за регистриране на профил в **Chatrix.One**. По този начин, ще имате възможност сами да избирате потребителското име. Паролата щв бъде генерирана автоматично, като разбира се имате възможност да я редактирате. В случай, че полето за парола е празно, ще трябва да полълните ръчно.
