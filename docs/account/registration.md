...
Регистрацията чрез покана Ви дава възможност сами да избирате потребителското име. Паролата, в зависимост от инсталирания клиент, може да бъде генерирана автоматично, или ще трябва Вие да я въведете.
