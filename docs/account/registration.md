...
!!! example "Пример"
    ...
    === "Имейл"
        ...
        * **Съдържание:**
        ...
        Бих желал(а) да получа покана за регистрация на профил в Chatrix.One, тъй като  регистрация през уебсайта и приложенията в момента не е активна.
        Причината да избера този сървър е:
        [Тук опишете накратко причината]
        Запознат(а) съм, че ако желая потребителското ми име да бъде включено в Shared Roster Group, е необходимо да се свържа с администратор чрез XMPP съобщение след регистрацията.
