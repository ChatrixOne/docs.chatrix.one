...
!!! example "Пример"
    ...
    === "Имейл"
        ...
        * **Съдържание:**
        ...
        Бих желал(а) да получа покана за регистрация в Chatrix.One,
        тъй като в момента регистрацията на профили през сайта и приложенията
        не е е активна. Наясно съм, че ако желая потребителското име да бъде
        включено в Shared Roster Group ще трябва да се свържа с администратор
        чрез XMPP съобщение.
